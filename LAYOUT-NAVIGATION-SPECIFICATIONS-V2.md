...
**Changes from v1.0:** Added header with title option (see Section 1.1)
...
**Version 2.0** extends v1.0 by adding an optional header variant that displays a title instead of (or alongside) the logo.
...
### 1.1 Header Variant: Logo Only (Default)

Use this variant when only the logo/brand name should be displayed.
...
- **Font family:** Montserrat:Medium (var(--navigation/appbar-titletext/font-family))
- **Font size:** 20px (var(--navigation/appbar-titletext/font-size))
- **Font weight:** 500 (var(--navigation/appbar-titletext/font-weight))
- **Line height:** 16px
- **Color:** `#FFFFFF` (white)
- **White-space:** nowrap
- **Padding:** 0 20px (left/right spacing from logo and user section)

**Logo Icon (when using title):**
- Use Font Awesome icon instead of text logo
- Example: `<i class="fa-light fa-circle-cc"></i>`
- **Size:** 24px
- **Color:** `#FFFFFF`
- **Padding:** 10px

**Responsive Behavior:**
- **Desktop (>1024px):** Full title visible
- **Tablet (≤1024px):** Title may truncate with ellipsis
- **Mobile (≤600px):** Consider hiding title or using shorter version

### Header Structure

**Note:** The HTML structure above shows the two variants. Choose one based on your needs.
...
```
┌─────────────────────────────────────────────────────────────────┐
│  LOGO ONLY VARIANT (Default)                          60px      │
├─────────────────────────────────────────────────────────────────┤
│  [≡] ConstructConnect                            CD  User Name  │
└─────────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────────┐
│  WITH TITLE VARIANT (v2.0)                             60px     │
├─────────────────────────────────────────────────────────────────┤
│  [≡] ⓒ  Project Dashboard                       CD  User Name  │
└─────────────────────────────────────────────────────────────────┘

Legend:
[≡] = Hamburger menu (mobile only)
ⓒ  = Logo icon (Font Awesome)
CD = User avatar
```

**When to use each variant:**
- **Logo Only:** General pages, dashboards, or when no specific page context needed
- **With Title:** Specific workflows, project pages, or when users need clear page identification
...
/* Header Title (v2.0 - Title Variant) */
.header-title {
  color: #FFFFFF;
  font-family: var(--navigation/appbar-titletext/font-family, 'Montserrat', sans-serif);
  font-size: var(--navigation/appbar-titletext/font-size, 20px);
  font-weight: var(--navigation/appbar-titletext/font-weight, 500);
  line-height: 16px;
  white-space: nowrap;
  margin: 0;
  padding: 0 20px;
...
/* Logo Icon (when using title variant) */
.logo i {
  font-size: 24px;
  color: #FFFFFF;
}
